      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <>
            ...
            <Link
              to="/login"
              className="max-md:hidden flex  items-center gap-2 px-3 py-2 text-white"
            >
              Login
            </Link>
            <Link
        ...
        <div
          className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${
            isMenuOpen
              ? "max-md:h-screen max-md:opacity-100"
        ...
        >
          <ul className="flex flex-col md:flex-row gap-4 font-medium max-md:p-4 max-md:mt-5 max-md:border max-md:border-gray-500 max-md:bg-[#052e22] rounded-lg">
            ...
            <Link
              to="/login"
              className="md:hidden flex  items-center gap-2 px-3 py-2 text-white"
            >
              Login
            </Link>
            <Link
